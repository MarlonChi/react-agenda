            ...
            <div className="backdrop">
                <div className="modalNewContact">
                    ...
                    <div className="headerNewContact">
                        <span className="spnTitle"> Novo Contato </span>
                    ...
                    <div className="formNewContact"> 
                        <div className="row">
                            ...
                            <input id="txtNameContact" type="text" placeholder='Nome' ref="name"/>
                        </div>

                        <div className="row">
                            <i className="fas fa-phone"></i>
                            <input id="txtPhoneContact" type="text" placeholder='Telefone' ref="phone"/>
                        </div>
